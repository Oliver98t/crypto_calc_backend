...
if __name__ == "__main__":
    #crypto = 'eth'
    #write_crypto_data_to_csv(filename=f"{crypto}_gbp.csv", pair={'currency': 'gbp', 'crypto_currency': crypto})
    pair = "eth_gbp"
    ingest_csv_to_db(f'CoinDeskAPI/data/{pair}.csv', table_name=pair)
